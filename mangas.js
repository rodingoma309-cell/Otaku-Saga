...
const mangasDatabase = [
  ...
  },
  {
    ...
    category: "action",
    description:
      "Ken Kaneki devient un demi-ghoul après une greffe d'organe et doit apprendre à vivre entre deux mondes.",
    image: "tokyo.jpeg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Light Yagami trouve un carnet qui permet de tuer quiconque en écrivant son nom, et décide de créer un monde parfait.",
    image: "death.jpg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Les frères Elric utilisent l'alchimie pour retrouver leurs corps après une tentative de résurrection ratée.",
    image: "full.jpeg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Les aventures de Goku et ses amis qui défendent la Terre contre des ennemis de plus en plus puissants.",
    image: "dragon.jpeg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Ichigo Kurosaki devient un Shinigami et protège les vivants des Hollows et guide les âmes vers l'au-delà.",
  ...
  },
  {
    ...
    category: "romance",
    description:
      "Tohru Honda découvre que la famille Sohma est maudite par les animaux du zodiaque chinois.",
    image: "basket.jpeg",
  ...
  },
  {
    ...
    category: "romance",
    description:
      "Deux adolescents échangent leurs corps et doivent trouver un moyen de se rencontrer.",
    image: "https://cdn.myanimelist.net/images/manga/2/253146.jpg",
    seasons: "Film (2016)",
    rating: 4.9,
  },
  {
    ...
    category: "action",
    description:
      "Shoyo Hinata rejoint l'équipe de volley-ball de son lycée pour devenir le meilleur joueur.",
    image: "https://cdn.myanimelist.net/images/manga/2/253146.jpg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Saitama est un héros si puissant qu'il peut vaincre n'importe quel ennemi d'un seul coup de poing.",
    image: "https://cdn.myanimelist.net/images/manga/2/253146.jpg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Shigeo Kageyama, un élève avec des pouvoirs psychiques, travaille pour un escroc qui prétend être un exorciste.",
    image: "https://cdn.myanimelist.net/images/manga/2/253146.jpg",
  ...
  },
  {
    ...
    category: "action",
    description:
      "Des orphelins découvrent que leur orphelinat est en fait une ferme où ils sont élevés pour être mangés par des démons.",
    image: "https://cdn.myanimelist.net/images/manga/2/253146.jpg",
...
function generateMoreMangas() {
  ...
  for (let i = 0; i < 80; i++) {
    ...
    additionalMangas.push({
      ...
      image: imageUrl,
      seasons: `Saison ${Math.floor(Math.random() * 5) + 1} (${
        2015 + Math.floor(Math.random() * 9)
      }-${Math.random() > 0.5 ? "présent" : "terminé"})`,
